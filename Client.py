...
function_url = 'https://europe-west1-projectlv.cloudfunctions.net/save_http'
with open ('Input.csv') as f:
    ...
    for r in f:
        ...
        r = post(function_url, data= {'data': json.dumps({'sensor':'sensor2', 'time':t, 'use[kW]':useKW, 'gen[kW]':generateKW, 'House_overall[kW]':house_overallKW,
