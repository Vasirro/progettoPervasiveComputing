...
import time
import json
function_url = 'https://europe-west1-projectlv.cloudfunctions.net/save_data'
with open ('Input.csv') as f:
    ...
    for r in f:
        ...
        r = post(function_url, data= {'data': json.dumps({'sensor':'sensor1', 'time':t, 'use[kW]':useKW, 'gen[kW]':generateKW, 'House_overall[kW]':house_overallKW,
